...
const paths: Record<string, React.ReactNode> = {
  ...
  crown: <path d="M2 18h20l-2-11-5 4-3-7-3 7-5-4-2 11z" />,
  plus: (
    <>
  ...
  sparkles: <path d="M12 3l1.9 5.7L19.6 10l-5.7 1.9L12 17.6l-1.9-5.7L4.4 10l5.7-1.9Z" />,
  clock: (
    <>
...
export const categoryGradient: Record<string, string> = {
  templates: 'from-pink-500 to-rose-500',
