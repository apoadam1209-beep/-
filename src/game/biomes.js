...
export const BIOMES = [
  {
    ...
    fog: 0x140b2e,
    fogDensity: 0.0062,
    // Night. This world is named for bioluminescent shard fields and the
    // daylight version simply could not show them — glowing rock against a
    // bright sky is grey rock. Side by side the night key read far better.
    ...
    sun: [0xb98bff, 2.5],
    sunPos: [-24, 34, -30],
    ground: { style: 'crystal', base: 0x2a1c4d, accent: 0x5b3f9e, glow: 0x9b6bff, repeat: [3, 8], rough: 0.45, metal: 0.25, albedo: 0.125 },
    laneGlow: 0x7fc8ff, // violet markings on a violet deck were invisible
    skyline: { style: 'spires', color: 0x231645 },
    prop: crystalProp,
  ...
  },
  {
    ...
    sky: [0x0d3a68, 0x3f7288, 0x8fae63],
    stars: 0.0,
    skyFeature: null,
    hemi: [0x9fd8bf, 0x12271a, 1.1],
    sun: [0xfff2cc, 2.4],
    sunPos: [18, 44, -34],
    ground: { style: 'jungle', base: 0x1d3a24, accent: 0x3f7a3c, glow: 0x6bffb0, repeat: [3, 8], rough: 0.85, metal: 0.0, albedo: 0.105 },
    laneGlow: 0x6bffb0,
